...
namespace Foundation.Databinding
{
    ...
    public class ToggleBinder : BindingBase
    {
        ...
        private void UpdateValue(object o)
        {
            if (UseStaticValue)
            {
                // if the member value equals the static value, then this toggle should be on.
                string newValue = o != null ? o.ToString() : null;
                Target.isOn = (newValue == StaticValue);
            }
            else
            {
                Target.isOn = (bool)o;
        ...
        public override void Init()
        {
            ...
            StaticValueBinding.Action = UpdateValue;
